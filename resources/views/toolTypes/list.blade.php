...
<section class="w3-padding ca-container-large">
    ...
    @include ('layout.breadcrumbs', ['title' => 'Manage Tool Types', 'links' => ['Manage Tools' => '/tools/list']])

    <table class="w3-table w3-stripped w3-bordered w3-margin-bottom">
        <tr class="w3-dark-grey">
            <th>Title</th>
            <th class="w3-center">Tools</th>
    ...
    @include ('layout.forms.button', ['label' => 'Add Tool Type', 'href' => '/tools/types/add'])
